...
ServerEvents.recipes(event => {
    ...
    event.recipes.ars_nouveau.enchanting_apparatus(['refinedstorage:quartz_enriched_iron'],
         "minecraft:gold_block", "6x submerged:quartz_enriched_gold", 1000
